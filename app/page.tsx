...
export default function Home() {
  return (
    ...
    <div className="flex flex-col flex-1 items-center justify-center font-sans">
      <main className="flex flex-1 flex-col justify-center w-full 2xl:max-w-1/2 items-center xl:py-32 md:px-16 sm:items-start">
        <div className="w-full flex flex-wrap flex-row min-h-3/4 p-5">
          <div className="grow content-center">
            <h1 className="text-4xl text-white font-extrabold md:text-start text-center">Hi, I'm <span className="text-primary">Korrawit <span className="md:inline-block hidden">Soodnalao</span></span></h1>
            ...
            <div className="flex md:justify-start justify-center items-center">
              <Link href="">
                <LinkedInIcon className="size-6 m-2" />
              </Link>
              <Link href="">
                <GithubIcon  className="size-6 m-2" />
              </Link>
            </div>
          </div>
