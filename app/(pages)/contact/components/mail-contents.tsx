export default function MailContents({ mail, copy }: { mail: ResumeMail, copy: MailContentsCopy }) {
    return (
        <div className="space-y-2 rounded-xl border border-white/10 bg-white/5 p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-white/50">{copy.includes_label}</p>
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
                <p className="text-xs font-semibold uppercase tracking-wide text-white/50">{copy.reply_label}</p>
