    ...
    return (
        <>
            <div className="flex flex-col flex-1 items-center justify-center font-sans">
                <main className="md:grid md:grid-cols-2 md:gap-6 gap-6 justify-center w-full 2xl:max-w-1/2 items-center justify-between xl:py-32 md:px-16 sm:items-start">
                    <div className="justify-center mb-6 px-6">
                        <p className="md:text-start text-center text-white text-balance">
