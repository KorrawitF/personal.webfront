    ...
    return (
        <div className="flex flex-1 flex-col items-center font-sans">
            <section className="grid w-full max-w-6xl grid-cols-1 gap-10 px-6 py-12 md:grid-cols-2 md:items-start md:gap-12 md:px-12 xl:py-24 2xl:max-w-5xl">
                ...
                <TimeLine
                    className="max-h-[70dvh] overflow-y-auto overscroll-contain [scrollbar-color:color-mix(in_srgb,var(--foreground)_60%,transparent)_transparent] [scrollbar-width:thin]"
                    items={timeline}
                />
            </section>
        </div>
